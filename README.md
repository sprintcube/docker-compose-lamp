...
This environment gives you the basic tools you need for the PHP and frontend development:
* PHP
* Apache
* MySQL/MariaDB
* phpMyAdmin
...
![Landing Page](https://github.com/danielefavi/lamp-docker/raw/master/.github/images/LAMP-DOCKER-STACK-v2.png)
