                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            if (!$link) {
                                ...
                                /* print server version */
                                printf("PostgreSQL Server %s", pg_version($link)['server']);
                            }
            ...
            <div class="column">
                ...
                <div class="content">
                    <ul>
                        ...
                        <li><a href="http://localhost:<?= $_ENV['PGA_PORT'] ?>">pgAdmin</a></li>
                        <li><a href="/test_db.php">Test DB Connection with mysqli</a></li>
                        <li><a href="/test_pg.php">Test DB Connection with pgi</a></li>
