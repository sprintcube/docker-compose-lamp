...
class PassportController extends Controller{
	public function actionService(){
		...
		$this->registerJsFile("/js/passport.js", ['position' => View::POS_END]);
	...
	public function actionAccountedit(){
		...
		$this->registerJsFile("/js/passport/profile.js", ['position' => View::POS_END]);
	...
	public function actionEventsedit(){
		...
		$this->registerJsFile("/js/passport/services.js", ['position' => View::POS_END]);
	...
	public function actionOffer(){
		...
		$this->registerJsFile("/js/passport/offers.js", ['position' => View::POS_END]);
	...
	public function actionCart(){
		...
		$this->registerJsFile("/js/passport/cart.js", ['position' => View::POS_END]);
