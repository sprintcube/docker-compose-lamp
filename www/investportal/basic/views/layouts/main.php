...
<?php } else if(Yii::$app->controller->id != 'Passport'){ echo '<script src="https://cdn.jsdelivr.net/npm/js-md5@0.7.3/src/md5.js"></script>'; }?>
		<?php $this->head() ?>
	</head>
	<?php $this->beginBody() ?>
	<body>
							...
							<div class="header-informer">
								...
								<footer>
									<div class="user-services">
										<div>
											<?php if(!$_COOKIE['portalUser']){ ?><a href="" data-profile="passport">Passport</a><?php } else{ ?><a href="">Join/Login</a><?php } ?>
